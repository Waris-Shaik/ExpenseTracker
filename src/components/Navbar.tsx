...
import { Moon, Sun, Wallet, LayoutDashboard, PlusCircle, Brain, Target } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-14">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
          >
